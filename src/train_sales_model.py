"""
Training Script for Sales Prediction Model (Superstore Sales Intelligence).
"""
...
from feature_engineering import get_sales_data, create_preprocessor
...
def train_sales_models():
    """Train multiple regression models to predict Sales and select the best model."""
    os.makedirs(MODELS_DIR, exist_ok=True)
    print("Loading dataset for Sales Model training...")
    df = load_data()
    ...
    print(f"Saved best Sales model pipeline to {model_path}")
